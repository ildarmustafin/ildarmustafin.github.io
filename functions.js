...
let test_json = "{\"now\":\"2023-11-29T11:59:50\",\"t\":85,\"led\":11,\"rssi\":-78,\"bf\":7,\"heap\":17992}";
...
*/
	...
	btn31.addEventListener("click", function(event){ 
		...
		let jsonData = '';
		let chk = 0;
		for (let i = 19; i <= 26; i++) {chk += (document.getElementById("input2" + i).checked) << (i-9);}
		document.getElementById('input218').value = chk;
		for (let i = 0; i <= 18; i++) {jsonData += 'input[2]['+i+']='+document.getElementById('input2'+i).value+'&';}
